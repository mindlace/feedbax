...
/// hueShift, satDelta, lightDelta — so `MemoryLayout<WarpParams>.stride` lines up with
/// the Metal struct's byte layout (float2 needs 8-byte alignment; this order avoids any
/// padding mismatch between the two compilers' layout rules).
